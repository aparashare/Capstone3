...
from fmm.user.serializers import (UserRegistrationSerializer, UserPersonalInfoSerializer,
                                  ...
                                  UserMentorAccountPublicGetSerializer)
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def yuwee_register(self, request, pk):
        ...
        helper = YuweeHelper()
        resp = helper.register_user(user=user)
...
class UserMentorAccountPublicViewSet(mixins.ListModelMixin, GenericViewSet):
    serializer_class = UserMentorAccountPublicGetSerializer
    queryset = UserMentorAccount.objects.all()
    filter_class = UserMentorAccountFilter
    filter_backends = (django_filters.rest_framework.DjangoFilterBackend,
                       filters.OrderingFilter, filters.SearchFilter)
